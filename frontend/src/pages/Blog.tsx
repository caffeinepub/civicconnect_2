      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            Stay updated with the latest compliance news, regulatory changes, and business tips for India.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          {isLoading && (
            <div className="flex flex-col gap-6">
              {[1, 2, 3].map((i) => (
                ...
                >
                  <Skeleton className="h-6 w-3/4 mb-3" style={{ backgroundColor: 'rgba(255,255,255,0.08)' }} />
                  <Skeleton className="h-4 w-1/2 mb-4" style={{ backgroundColor: 'rgba(255,255,255,0.06)' }} />
                  <Skeleton className="h-4 w-full mb-2" style={{ backgroundColor: 'rgba(255,255,255,0.06)' }} />
                  <Skeleton className="h-4 w-5/6" style={{ backgroundColor: 'rgba(255,255,255,0.06)' }} />
                </div>
              ))}
            </div>
          )}
          ...
          {isError && (
            <div
              ...
              style={{ backgroundColor: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)' }}
            >
              <p className="text-red-400 font-medium">Failed to load blog posts. Please try again later.</p>
            </div>
          )}
          ...
          {!isLoading && !isError && posts && posts.length === 0 && (
            ...
            >
              ...
              <p className="text-gray-400">Check back soon for compliance tips and business insights.</p>
            </div>
          )}
