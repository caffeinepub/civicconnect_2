        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <p className="text-gray-300 leading-relaxed mb-0">
              Please read these Terms &amp; Conditions carefully before using the services offered by YMW Compliance Services LLP. These terms constitute a legally binding agreement between you and the Company.
            </p>
          </div>
