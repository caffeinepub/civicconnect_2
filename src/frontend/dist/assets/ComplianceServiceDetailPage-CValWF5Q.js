import { N as useParams, r as reactExports, j as jsxRuntimeExports, b as Link, P as Phone, M as MessageCircle, C as CircleCheckBig, a as ChevronDown, i as Mail } from "./index-B8PZBDeY.js";
import { g as getComplianceServiceBySlug } from "./complianceServices-BvnQnCiN.js";
...
const DEFAULT_PROCESS = [
  {
    ...
    desc: "Speak to our expert and understand the compliance requirements, timeline, and documents needed."
  },
  {
  ...
  },
  {
    ...
    desc: "Our team prepares and submits the application with the relevant government authority or department."
  },
  {
  ...
  },
  {
    ...
    desc: "Upon approval, the registration certificate is delivered to you and we advise on ongoing compliance."
  }
];
const DEFAULT_FAQS = [
  {
    q: "How long does the registration process take?",
    a: "Timelines vary by service. Simple registrations like MSME take 1–3 days, while others like PF/ESI registration take 7–15 days. We provide a clear estimate during consultation."
  },
  {
  ...
  },
  {
    ...
    a: "We deliver the certificate digitally and advise on renewal dates, monthly/quarterly filing requirements, and ongoing compliance to keep you fully compliant."
  }
];
function ComplianceServiceDetailPage() {
  const { serviceSlug } = useParams({ strict: false });
  const service = getComplianceServiceBySlug(serviceSlug ?? "");
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: "/services/compliance-service",
              className: "text-sm font-medium text-blue-600 hover:underline",
              children: "← Back to Compliance Services"
            }
          )
        ]
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 pt-6 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex items-center gap-2 text-sm text-gray-500 flex-wrap", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: "/services/compliance-service",
          className: "hover:text-blue-700 font-medium",
          "data-ocid": "breadcrumb.compliance.link",
          children: "Compliance Service"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "/" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 space-y-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            ...
            style: { color: "#0a1628" },
            "data-ocid": "back.compliance.link",
            children: [
...
export {
  ComplianceServiceDetailPage as default
};
