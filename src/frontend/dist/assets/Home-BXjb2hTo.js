import { c as createLucideIcon, r as reactExports, u as useSubmitConsultationRequest, j as jsxRuntimeExports, C as CircleCheckBig, P as Phone, a as ChevronDown, L as LoaderCircle, b as Link, M as MessageCircle, g as getUTMSource, S as Star, d as MapPin, e as Shield } from "./index-DYEOqzqc.js";
...
function Home() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { backgroundColor: "#0a1628" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 px-4", style: { backgroundColor: "#0d1f3c" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: FEATURED_SERVICES.map((service, index) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: service.link,
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute bottom-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ArrowRight,
                  {
                    className: "w-4 h-4",
                    style: { color: "#f5c518" }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-6 flex justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          ...
          children: "🔍 Search Company Name & CIN"
        }
      ) }),
