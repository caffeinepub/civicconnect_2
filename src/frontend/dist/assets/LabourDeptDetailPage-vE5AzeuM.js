...
import { g as getLabourServiceBySlug } from "./labourDeptServices-DFB4xhaT.js";
...
const DEFAULT_PROCESS = [
  ...
  },
  {
    ...
    desc: "We guide you through collecting and preparing all required documents for the registration or filing."
  },
  {
...
const DEFAULT_FAQS = [
  {
    ...
    a: "Timelines vary by service. PF/ESI registration typically takes 7–15 days, while simpler registrations take less. We provide a clear estimate during consultation."
  },
  {
...
function LabourDeptDetailPage() {
  const { serviceSlug } = useParams({ strict: false });
  const service = getLabourServiceBySlug(serviceSlug ?? "");
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: "/services/labour-dept",
              className: "text-sm font-medium text-blue-600 hover:underline",
              children: "← Back to Labour Department"
            }
          )
        ]
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 pt-6 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex items-center gap-2 text-sm text-gray-500 flex-wrap", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: "/services/labour-dept",
          className: "hover:text-blue-700 font-medium",
          "data-ocid": "breadcrumb.labour.link",
          children: "Labour Department"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "/" }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-2 space-y-8", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Link,
          {
            ...
            style: { color: "#0a1628" },
            "data-ocid": "back.labour.link",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(ArrowLeft, { className: "w-4 h-4" }),
              " Back to Labour Department"
            ]
          }
        ) })
      ] }),
...
export {
  LabourDeptDetailPage as default
};
