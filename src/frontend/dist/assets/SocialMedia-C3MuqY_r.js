import { c as createLucideIcon, o, j as jsxRuntimeExports } from "./index-pQi0h6D3.js";
...
const PLATFORMS = [
  {
    name: "X (Twitter)",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SiX, { className: "w-7 h-7" }),
  ...
  {
    name: "Facebook",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SiFacebook, { className: "w-7 h-7" }),
  ...
  {
    name: "Instagram",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SiInstagram, { className: "w-7 h-7" }),
    handle: "@ymwcompliance",
    followers: "3.2K",
  ...
  {
    name: "LinkedIn",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SiLinkedin, { className: "w-7 h-7" }),
    handle: "YMW Compliance Services",
    followers: "4.8K",
  ...
  {
    name: "YouTube",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SiYoutube, { className: "w-7 h-7" }),
  ...
  {
    name: "GitHub",
    icon: /* @__PURE__ */ jsxRuntimeExports.jsx(SiGithub, { className: "w-7 h-7" }),
    handle: "ymwcompliance",
    followers: "320",
      ...
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl md:text-5xl font-extrabold text-white mb-4", children: [
            "Follow Us on ",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#f5c518" }, children: "Social Media" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-gray-300 max-w-2xl mx-auto", children: "Stay connected for the latest compliance updates, tips, and business insights." })
        ] })
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 px-4", style: { backgroundColor: "#0d1f3c" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6", children: PLATFORMS.map((platform) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
        href: platform.url,
        target: "_blank",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLink, { className: "w-4 h-4 text-gray-500 group-hover:text-gray-300 transition-colors" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-lg font-bold text-white mb-1", children: platform.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-400", children: platform.desc })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-auto", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl font-bold text-white", children: platform.followers }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-gray-400", children: "followers" })
          ] })
        ]
      },
      platform.name
