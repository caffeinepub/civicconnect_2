...
import { g as getStartupServiceBySlug } from "./startupServices-CmnEkkex.js";
...
const DEFAULT_PROCESS = [
  {
    ...
    desc: "Speak to our startup expert and understand the registration requirements, timeline, and documents needed."
  },
  {
    title: "Document Collection",
    desc: "We guide you through collecting and preparing all required documents for the startup registration or service."
  },
  {
    title: "Application Filing",
    desc: "Our team prepares and submits the application with the relevant government portal or authority."
  },
  {
    title: "Follow-up & Coordination",
    desc: "We follow up with the authority, coordinate any queries, and keep you updated throughout the process."
  },
  {
    title: "Certificate Delivery",
    desc: "Upon approval, the certificate or recognition is delivered to you along with guidance on next steps and ongoing compliance."
  }
];
const DEFAULT_FAQS = [
  {
    q: "Who is eligible for Startup India / DPIIT Recognition?",
    a: "Any company or LLP incorporated for less than 10 years, with annual turnover under Rs.100 Crore, and working towards innovation, development, or improvement of products or services is eligible."
  },
  {
    q: "How long does the registration process take?",
    a: "DPIIT Recognition typically takes 7–15 working days. Other services like patent filing take longer. We provide a clear timeline estimate during consultation."
  },
  {
    q: "What is the cost involved?",
    a: "Costs depend on the specific service. Contact us for a free consultation and transparent pricing with no hidden charges."
  },
  {
    q: "Is my information kept confidential?",
    a: "Absolutely. We treat all client and startup information with the highest level of confidentiality and data security."
  },
  {
    q: "Can an existing company apply for Startup India benefits?",
    a: "Yes, companies incorporated up to 10 years ago with turnover under Rs.100 Crore and a focus on innovation are eligible to apply for DPIIT Recognition and its associated benefits."
  }
];
function StartupServiceDetailPage() {
  const { serviceSlug } = useParams({ strict: false });
  const service = getStartupServiceBySlug(serviceSlug ?? "");
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Link,
            {
              to: "/services/startup-service",
              className: "text-sm font-medium text-blue-600 hover:underline",
              children: "← Back to Startup Services"
            }
          )
        ]
      }
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 pt-6 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex items-center gap-2 text-sm text-gray-500 flex-wrap", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: "/services/startup-service",
          className: "hover:text-blue-700 font-medium",
          "data-ocid": "breadcrumb.startup.link",
...
export {
  StartupServiceDetailPage as default
};
