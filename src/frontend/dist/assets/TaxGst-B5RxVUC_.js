import { r as reactExports, j as jsxRuntimeExports, b as Link, P as Phone, C as CircleCheckBig } from "./index-DwCD6ubM.js";
import { F as FreeConsultationSection } from "./FreeConsultationSection-BAla1TZY.js";
import { T as TAX_GST_SERVICES } from "./taxGstServices-dfoAo7yB.js";
...
function TaxGst() {
  ...
  const INDIRECT_TAX = TAX_GST_SERVICES.filter(
    (s) => [
      "gst-registration",
      "gst-return-filing",
      "gst-lut-for-export",
  ...
  const DIRECT_TAX = TAX_GST_SERVICES.filter(
    (s) => [
      ...
      "section",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-300", children: "Tax & GST" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-4xl md:text-5xl font-extrabold text-white mb-4", children: [
              "Tax & GST ",
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#f5c518" }, children: "Services" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg text-gray-300 mb-8 max-w-2xl mx-auto", children: "From GST registration and return filing to ITR, TDS, and tax notices — we handle all your direct and indirect tax compliance with accuracy and timeliness." }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-16 px-4", style: { backgroundColor: "#0d1f3c" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h2", { className: "text-2xl md:text-3xl font-extrabold text-white mb-2", children: [
          "Choose Your ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "#f5c518" }, children: "Tax Service" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-sm max-w-xl mx-auto", children: "Select a category below and click any service to see full details, benefits, required documents, and process." })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            "data-ocid": "indirect.panel",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  type: "button",
                  onClick: () => setOpenSection(openSection === "indirect" ? null : "indirect"),
                  className: "w-full flex items-center justify-between px-6 py-4 text-left",
                  style: { backgroundColor: "rgba(245,197,24,0.10)" },
                  "data-ocid": "indirect.toggle",
                  "aria-expanded": openSection === "indirect",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "🧾" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-bold text-base", children: "GST / Indirect Tax Services" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-xs mt-0.5", children: "4 services — GST Registration, Returns, LUT, Annual Return" })
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ArrowRight,
                      {
                        className: `w-5 h-5 transition-transform duration-200 ${openSection === "indirect" ? "rotate-90" : ""}`,
                        style: { color: "#f5c518" }
                      }
                    )
                  ]
              ...
              openSection === "indirect" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-5",
                  style: { backgroundColor: "rgba(255,255,255,0.02)" },
                  children: INDIRECT_TAX.map((service, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Link,
                    {
                      to: "/services/tax-gst/$serviceSlug",
                      ...
                      "data-ocid": `indirect.service.item.${idx + 1}`,
                      children: [
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                ...
                {
                  type: "button",
                  onClick: () => setOpenSection(openSection === "direct" ? null : "direct"),
                  className: "w-full flex items-center justify-between px-6 py-4 text-left",
                  style: { backgroundColor: "rgba(245,197,24,0.10)" },
                  "data-ocid": "direct.toggle",
                  "aria-expanded": openSection === "direct",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: "💼" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-bold text-base", children: "Income Tax / Direct Tax Services" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gray-400 text-xs mt-0.5", children: "4 services — ITR Filing, TDS Return, Tax Notices" })
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      ArrowRight,
                      {
                        className: `w-5 h-5 transition-transform duration-200 ${openSection === "direct" ? "rotate-90" : ""}`,
                        style: { color: "#f5c518" }
                      }
                    )
                  ]
              ...
              openSection === "direct" && /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-5",
                  style: { backgroundColor: "rgba(255,255,255,0.02)" },
                  children: DIRECT_TAX.map((service, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Link,
                    {
                      to: "/services/tax-gst/$serviceSlug",
                      params: { serviceSlug: service.slug },
                      ...
                      "data-ocid": `direct.service.item.${idx + 1}`,
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl flex-shrink-0", children: service.icon }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-white font-semibold text-sm leading-snug group-hover:text-yellow-300 transition-colors", children: service.title }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "py-12 px-4", style: { backgroundColor: "#f5c518" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "h2",
        {
          ...
          style: { color: "#0a1628" },
          children: "Need Tax or GST Guidance?"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "p",
        {
          ...
          children: "Our CA experts are available Mon–Sat 10 AM to 6 PM for a free consultation."
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-4 justify-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
