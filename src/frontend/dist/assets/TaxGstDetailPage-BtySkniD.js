...
import { g as getServiceBySlug } from "./taxGstServices-dfoAo7yB.js";
...
const DEFAULT_PROCESS = [
  {
    ...
    desc: "Speak to our tax expert and understand the process, timeline, and documents needed."
  },
  {
    title: "Document Collection",
    desc: "We guide you through collecting and preparing all required documents and financial data."
  },
  {
    title: "Application / Filing",
    desc: "Our CA team prepares and submits the application or return with the relevant authority."
  },
  {
    title: "Follow-up & Compliance",
    desc: "We follow up with the department and ensure all queries are resolved promptly."
  },
  {
    title: "Certificate / Acknowledgement Delivery",
    desc: "Upon completion, all certificates and acknowledgements are delivered to you digitally."
  }
];
const DEFAULT_FAQS = [
  {
    q: "How long does the process take?",
    a: "Timelines vary by service — GST registration is typically 3–7 working days, while ITR filing can be done on the same day. Our team will provide a clear estimate upfront."
  },
  {
    q: "What is the cost involved?",
    a: "Costs depend on the service and complexity. Contact us for a free consultation and transparent pricing with no hidden charges."
  },
  {
    q: "Do I need to visit any government office?",
    a: "No. All tax filings and registrations are done online. You only need to provide documents and sign where required."
  },
  {
  ...
  {
    q: "What happens after the service is completed?",
    a: "We deliver all certificates, acknowledgements, and filed returns digitally. We also advise on ongoing compliance requirements."
  }
];
function TaxGstDetailPage() {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-6xl mx-auto px-4 pt-6 pb-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex items-center gap-2 text-sm text-gray-500 flex-wrap", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Link,
        {
          to: "/services/tax-gst",
          className: "hover:text-blue-700 font-medium",
          "data-ocid": "breadcrumb.taxgst.link",
          children: "Tax & GST"
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "/" }),
