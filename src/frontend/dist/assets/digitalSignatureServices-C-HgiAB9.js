const DSC_SERVICES = [
  {
    ...
    icon: "🔐",
    description: "Class 3 DSC is the highest level of digital signature used for e-tendering, e-auctions, income tax filing, and MCA filings. It provides the strongest identity verification and is mandatory for government portal registrations.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🏢",
    description: "Digital Signature Certificate for authorized signatories of Private Limited Companies, LLPs, and other entities. Required for MCA filings, GST registration, and other regulatory submissions on behalf of the company.",
    benefits: [
  ...
  },
  {
    ...
    icon: "📋",
    description: "A specific Digital Signature Certificate used for signing GST registration applications and returns. Required for companies and LLPs when applying for GST registration and filing GST returns on the GSTN portal.",
    benefits: [
  ...
  },
  {
    ...
    icon: "💼",
    description: "Digital Signature Certificate used for signing and verifying income tax returns and other documents on the Income Tax e-filing portal. Mandatory for companies and recommended for individuals with complex filings.",
    benefits: [
  ...
  },
  {
    ...
    icon: "📑",
    description: "Class 3 Digital Signature Certificate used for participation in government e-tenders and e-procurement portals including GeM, CPPP, IREPS, and state procurement portals. Mandatory for all e-tender submissions.",
    benefits: [
  ...
  },
  {
    ...
    title: "DSC Renewal",
    icon: "🔄",
    description: "Renew your existing Digital Signature Certificate before it expires. DSCs are valid for 1 or 2 years; timely renewal ensures uninterrupted access to e-filing portals and government services.",
    benefits: [
...
function getDSCServiceBySlug(slug) {
  return DSC_SERVICES.find((s) => s.slug === slug);
}
export {
  DSC_CATEGORIES as D,
  DSC_SERVICES as a,
  getDSCServiceBySlug as g
};
