const ISO_CERTIFICATION_SERVICES = [
  ...
  },
  {
    ...
    icon: "🍽️",
    description: "ISO 22000 is an international standard for Food Safety Management Systems (FSMS). It applies to all organizations in the food chain — from farm to fork — including food manufacturers, processors, retailers, and packaging companies. It integrates HACCP principles with ISO management system requirements.",
    benefits: [
  ...
  },
  {
    ...
    icon: "👷",
    description: "ISO 45001 is the international standard for Occupational Health and Safety (OH&S) Management Systems. It helps organizations reduce workplace injuries, illnesses, and fatalities. Mandatory in high-risk industries like construction, mining, manufacturing, and chemicals.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🔐",
    description: "ISO 27001 is the leading international standard for Information Security Management Systems (ISMS). It provides a framework to protect sensitive company and customer data from cyber threats, data breaches, and unauthorized access. Essential for IT companies, BPOs, fintech, and any data-driven business.",
    benefits: [
  ...
  },
  {
    ...
    icon: "⚡",
    description: "ISO 50001 provides a framework for organizations to manage energy performance, including energy efficiency, use, and consumption. It helps industries reduce energy costs, meet sustainability goals, and comply with energy conservation regulations.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🏥",
    description: "ISO 13485 specifies requirements for a Quality Management System for medical device manufacturers and related service providers. It is required for regulatory compliance and market access for medical devices in India and internationally.",
    benefits: [
  ...
  },
  {
    ...
    icon: "⚖️",
    description: "ISO 37001 is the international standard for Anti-Bribery Management Systems. It helps organizations establish, implement, and maintain an anti-bribery program to prevent, detect, and respond to bribery. Increasingly required by large corporates and government contractors.",
    benefits: [
...
export {
  ISO_CERTIFICATION_SERVICES as I,
