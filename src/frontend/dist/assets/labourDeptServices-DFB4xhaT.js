const LABOUR_SERVICES = [
  {
    ...
    icon: "🏦",
    description: "Provident Fund (PF) Registration under EPFO is mandatory for establishments with 20 or more employees. YMW Compliance ensures smooth PF registration, monthly ECR filing, and complete EPFO compliance management. Protect your employees and keep your business penalty-free.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🏥",
    description: "ESI Registration is mandatory for establishments with 10 or more employees drawing wages up to ₹21,000/month. YMW Compliance handles ESIC registration, monthly contribution filing, and employee card issuance to ensure full compliance. Secure your employees health and disability benefits.",
    benefits: [
  ...
  },
  {
    ...
    icon: "👷",
    description: "The Contract Labour (Regulation & Abolition) Act License is required for principal employers engaging 20+ contract workers and contractors supplying 20+ workers. YMW manages Form I/II application, liaison with Labour Commissioner, and ongoing compliance. Stay legally protected under CLRA Act 1970.",
    benefits: [
  ...
  },
  {
    ...
    icon: "💼",
    description: "Professional Tax is a state-level tax imposed on employment income and is mandatory in most states including Jharkhand. YMW helps businesses obtain PTEC and PTRC certificates, file monthly/quarterly returns, and maintain full compliance. Avoid penalties with our expert state-wise guidance.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🏪",
    description: "Shops and Establishments Act Registration is mandatory for all commercial establishments, shops, offices, and restaurants. YMW Compliance handles state-specific registration, ensures adherence to working hours and conditions, and manages annual renewals. Get your business legally registered in your state.",
    benefits: [
  ...
  },
  {
    ...
    icon: "📜",
    description: "Labour License is required for businesses engaged in construction, manufacturing, and specific industries under the Factories Act or state labour laws. YMW Compliance manages the complete application process, coordinates with the Labour Department, and ensures timely licence issuance and renewals.",
    benefits: [
  ...
  },
  {
    ...
    icon: "📊",
    description: "Monthly PF ECR (Electronic Challan cum Return) filing is mandatory for all PF-registered establishments. YMW Compliance handles timely ECR preparation, challan generation, and submission to EPFO portal every month. Avoid interest and penalties with our dedicated compliance team.",
    benefits: [
  ...
  },
  {
    ...
    icon: "📋",
    description: "Bi-annual ESI Return filing is required for all ESIC-registered establishments along with monthly contribution payments. YMW Compliance ensures accurate Return-1 filing, timely contribution deposit, and employee IP number management. Stay fully compliant with ESIC regulations.",
    benefits: [
  ...
  },
  {
    ...
    icon: "📑",
    description: "Professional Tax Return filing is mandatory for all PTRC-registered employers on a monthly or quarterly basis depending on the state. YMW Compliance prepares accurate PT challans, files returns, and manages employee-wise deductions and deposits on time.",
    benefits: [
  ...
  },
  {
    ...
    icon: "❤️",
    description: "Labour Welfare Fund (LWF) Registration and contribution is mandatory for establishments in states where LWF Act is applicable. YMW Compliance handles LWF registration, annual contribution filing, and maintains complete compliance records so your business avoids penalties.",
    benefits: [
...
const LABOUR_CATEGORIES = [
  {
    ...
    icon: "🏭",
    description: "6 services — PF, ESI, Contract Labour, Professional Tax, Shops Act, Labour License",
    slugs: [
      "pf-registration",
      "esi-registration",
  ...
  },
  {
    ...
    icon: "📋",
    description: "4 services — PF Returns, ESI Returns, Professional Tax Returns, Labour Welfare Fund",
    slugs: [
      "pf-return-filing",
      "esi-return-filing",
...
function getLabourServiceBySlug(slug) {
  return LABOUR_SERVICES.find((s) => s.slug === slug);
}
export {
  LABOUR_CATEGORIES as L,
  LABOUR_SERVICES as a,
  getLabourServiceBySlug as g
};
