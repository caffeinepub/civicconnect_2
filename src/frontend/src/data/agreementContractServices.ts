...
export const AGREEMENT_SERVICES: AgreementService[] = [
  {
    slug: "rental-agreement",
    title: "Rental Agreement / Lease Deed",
    icon: "🏠",
    description:
      "A legally binding rental or lease agreement between landlord and tenant, covering terms of occupancy, rent, duration, and conditions. Essential for residential and commercial property rentals in India.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🤝",
    description:
      "A partnership deed is a legal document that outlines the terms and conditions of a partnership business including profit sharing, roles, capital contribution, and exit clauses. Mandatory for registering a partnership firm.",
    benefits: [
  ...
  },
  {
    ...
    icon: "📜",
    description:
      "A Memorandum of Understanding (MoU) is a formal agreement between two or more parties that outlines the intent to collaborate, the scope of work, and terms of engagement. Used in business collaborations, joint ventures, and government tie-ups.",
    benefits: [
  ...
  },
  {
    ...
    icon: "📄",
    description:
      "A service agreement is a contract between a service provider and client defining deliverables, timelines, payment terms, and termination conditions. Essential for freelancers, consultants, agencies, and businesses offering services.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🔒",
    description:
      "A Non-Disclosure Agreement (NDA) is a legal contract that protects confidential business information shared between parties. Essential for startups, investors, employees, and business partners to prevent unauthorized disclosure.",
    benefits: [
  ...
  },
  {
    ...
    icon: "👔",
    description:
      "An employment agreement or offer letter defines the terms of employment including job role, compensation, working hours, leave policy, notice period, and exit clauses. Protects both employer and employee.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🏗️",
    description:
      "A sale deed is the primary legal document for transfer of property ownership in India. An agreement to sell documents the intention to sell before the final sale deed is registered. Both are essential for property transactions.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🏪",
    description:
      "A franchise agreement defines the rights, obligations, and terms between a franchisor and franchisee for running a franchise business. Covers territory rights, royalties, branding, and support obligations.",
    benefits: [
...
export const AGREEMENT_CATEGORIES: AgreementCategory[] = [
  {
...
export function getAgreementServiceBySlug(
  slug: string,
): AgreementService | undefined {
