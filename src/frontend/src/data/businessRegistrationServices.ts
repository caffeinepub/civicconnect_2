export interface ServiceDetail {
  ...
  icon: string;
  title: string;
  category: "company" | "ngo";
  description: string;
  benefits: string[];
  documents: string[];
}

export const BUSINESS_REGISTRATION_SERVICES: ServiceDetail[] = [
  // ── Company Registration ──
  {
    ...
    category: "company",
    description:
      "A Private Limited Company is India's most preferred business structure for startups and growing enterprises. It offers limited liability protection to shareholders, making it ideal for raising investment. With a separate legal identity, it can own property, enter contracts, and sue or be sued in its own name.",
    benefits: [
  ...
  },
  {
    ...
    category: "company",
    description:
      "An LLP combines the flexibility of a partnership with the limited liability protection of a company. It is the preferred structure for professional firms, consultants, and small businesses. Partners are not personally liable for the debts of the LLP, and compliance requirements are lighter than a Private Limited Company.",
    benefits: [
  ...
  },
  {
    ...
    category: "company",
    description:
      "An OPC is designed for solo entrepreneurs who want to enjoy the benefits of a corporate structure — limited liability and a separate legal entity — without needing multiple shareholders. It allows a single founder to run a company with full control while having the credibility of an incorporated business.",
    benefits: [
  ...
  },
  {
    ...
    category: "ngo",
    description:
      "CSR-1 is a mandatory registration on the MCA portal for NGOs, Trusts, and Societies wishing to receive Corporate Social Responsibility funds from companies. Under the Companies Act 2013, companies with prescribed turnover / profit must spend 2% of net profits on CSR — and can only channel these funds to organisations holding a valid CSR-1 registration.",
    benefits: [
  ...
  },
  {
    ...
    category: "ngo",
    description:
      "Section 12A of the Income Tax Act grants income tax exemption to charitable and religious trusts, societies, and Section 8 companies. Once registered under 12A, the organisation's income is exempt from income tax — provided it is applied for charitable purposes. It is a prerequisite for many government grants and FCRA registration.",
    benefits: [
  ...
  },
  {
    ...
    category: "ngo",
    description:
      "Section 80G of the Income Tax Act allows donors to claim a deduction on the amount donated to eligible charitable organisations. Getting 80G registration for your NGO or trust significantly increases donor motivation, as their contribution becomes tax-deductible. It is one of the most sought-after registrations for fundraising NGOs.",
    benefits: [
  ...
  },
  {
    ...
    category: "ngo",
    description:
      "NGO Darpan is an online platform managed by NITI Aayog and NIC where NGOs, Voluntary Organisations, and other civil society organisations can register and receive a unique ID. This registration is mandatory for accessing government grants, central ministry funds, FCRA renewals, and CSR-1 filings. It improves transparency and enables real-time tracking.",
    benefits: [
...
export const COMPANY_SERVICES = BUSINESS_REGISTRATION_SERVICES.filter(
  (s) => s.category === "company",
);
export const NGO_SERVICES = BUSINESS_REGISTRATION_SERVICES.filter(
  (s) => s.category === "ngo",
);
