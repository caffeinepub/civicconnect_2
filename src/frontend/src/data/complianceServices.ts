export interface ComplianceServiceItem {
  slug: string;
  title: string;
  icon: string;
  description: string;
...
export const COMPLIANCE_SERVICES: ComplianceServiceItem[] = [
  {
    slug: "pf-registration",
    title: "PF Registration (Provident Fund)",
    icon: "🏦",
    description:
      "Provident Fund (PF) Registration under EPFO is mandatory for establishments with 20 or more employees. YMW Compliance ensures smooth PF registration, monthly compliance, and complete ECR filing support so your business remains fully compliant.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🏥",
    description:
      "ESI Registration is mandatory for establishments with 10 or more employees drawing wages up to ₹21,000/month. YMW Compliance handles ESIC registration, monthly contribution filing, and employee card issuance to ensure full compliance.",
    benefits: [
  ...
  },
  {
    ...
    icon: "👷",
    description:
      "The Contract Labour (Regulation & Abolition) Act License is required for principal employers engaging 20+ contract workers and contractors supplying 20+ workers. YMW manages Form I/II application, liaison with Labour Commissioner, and ongoing compliance.",
    benefits: [
  ...
  },
  {
    ...
    icon: "💼",
    description:
      "Professional Tax is a state-level tax imposed on employment income and is mandatory in most states. YMW helps businesses obtain Professional Tax Enrollment Certificate (PTEC) and Registration Certificate (PTRC), file monthly/quarterly returns, and maintain compliance.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🏭",
    description:
      "MSME Udyam Registration is a government recognition for micro, small, and medium enterprises. It unlocks priority lending, subsidies, government tenders, and tax benefits. YMW ensures accurate Udyam Registration and post-registration compliance.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🌏",
    description:
      "Import Export Code (IEC) is a 10-digit business identification number mandatory for businesses engaged in import or export of goods/services. YMW provides end-to-end IEC registration with DGFT and helps you start global trading quickly.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🛒",
    description:
      "Government e-Marketplace (GeM) is the national procurement portal for government departments and PSUs. YMW Compliance helps businesses register as sellers on GeM, set up product/service listings, and secure government orders through the platform.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🏗️",
    description:
      "Real Estate Regulatory Authority (RERA) Registration is mandatory for real estate developers and agents under the RERA Act 2016. YMW provides complete RERA project and agent registration, compliance support, and renewal services across India.",
    benefits: [
...
export function getComplianceServiceBySlug(
  slug: string,
): ComplianceServiceItem | undefined {
