export interface GovLicenseItem {
  slug: string;
  title: string;
  icon: string;
  description: string;
...
export const GOVERNMENT_LICENSES_SERVICES: GovLicenseItem[] = [
  {
    slug: "trade-license",
    title: "Trade License",
    icon: "🏪",
    description:
      "A Trade License is a certificate/document that gives permission to the applicant to commence a particular trade or business in a specific location. It is issued by the local municipal authority and is mandatory for all businesses operating from a fixed premises.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🛡️",
    description:
      "The Private Security Agencies (Regulation) Act (PSARA) License is mandatory for any agency providing security guard services in India. YMW helps you obtain PSARA license from the state government with complete documentation and compliance support.",
    benefits: [
  ...
  },
  {
    ...
    icon: "⚗️",
    description:
      "The Petroleum and Explosives Safety Organisation (PESO) License is required for businesses dealing with petroleum products, explosives, compressed gases, and other hazardous materials. YMW provides end-to-end PESO license application and compliance support.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🌿",
    description:
      "The AYUSH License is required for manufacturing, sale, and distribution of Ayurvedic, Unani, Siddha, Homeopathic, and other traditional medicine products. YMW helps you navigate the complex state and central AYUSH regulatory requirements.",
    benefits: [
  ...
  },
  {
    ...
    icon: "⛏️",
    description:
      "A Mining License (Mining Lease / Composite License) is required for extraction of minerals from land. YMW provides expert guidance for obtaining mining leases, reconnaissance permits, prospecting licenses, and related environmental clearances across Indian states.",
    benefits: [
  ...
  },
  {
    ...
    icon: "💊",
    description:
      "A Drug License is mandatory for manufacturing, sale, distribution, and storage of drugs and pharmaceuticals in India. YMW helps pharmacies, wholesale distributors, and pharmaceutical companies obtain the correct drug license from state authorities.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🏬",
    description:
      "The Shop and Establishment Act Registration is mandatory for all commercial establishments, shops, and offices. It governs working hours, employee rights, wages, and holidays. YMW ensures quick registration with the local labour department.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🔥",
    description:
      "A Fire No Objection Certificate (Fire NOC) is mandatory for commercial establishments, hotels, hospitals, factories, and multi-storey buildings. YMW assists in obtaining Fire NOC from the state fire department after ensuring all fire safety compliance requirements are met.",
    benefits: [
...
export function getServiceBySlug(slug: string): GovLicenseItem | undefined {
