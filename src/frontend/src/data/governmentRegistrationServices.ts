export interface GovtRegServiceItem {
  slug: string;
  title: string;
  icon: string;
  description: string;
...
export const GOVT_REG_SERVICES: GovtRegServiceItem[] = [
  {
    slug: "import-export-code",
    title: "Import Export Code (IEC)",
    icon: "🌐",
    description:
      "Import Export Code (IEC) is a 10-digit code issued by the Directorate General of Foreign Trade (DGFT) and is mandatory for any business involved in importing or exporting goods and services from India. YMW Compliance handles the complete IEC registration process, ensuring quick approval and full compliance with DGFT regulations.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🏭",
    description:
      "Udyam Registration (formerly MSME Registration) is a government certification for Micro, Small, and Medium Enterprises. It enables access to government schemes, subsidies, priority sector lending, and protection under MSMED Act. YMW Compliance assists businesses in obtaining their Udyam Certificate quickly and at minimal cost.",
    benefits: [
...
export const GOVT_REG_CATEGORIES = [
  {
    key: "trade-import",
    title: "Trade & Import-Export Registrations",
    description:
      "IEC, ICEGATE, APEDA — for businesses engaged in international trade",
    icon: "🌐",
  ...
  },
  {
    ...
    description:
      "MSME, RERA, Fire NOC, BIS — essential registrations for business operations",
    icon: "🏛️",
    slugs: [
      "msme-registration",
      "rera-registration",
...
export function getGovtRegServiceBySlug(
  slug: string,
): GovtRegServiceItem | undefined {
