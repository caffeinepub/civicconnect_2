...
export const POLLUTION_CONTROL_SERVICES: ServiceItem[] = [
  {
    slug: "cte-cto-certificate",
    title: "CTE / CTO Certificate (Consent to Establish / Operate)",
    icon: "🏭",
    description:
      "Consent to Establish (CTE) and Consent to Operate (CTO) are mandatory approvals from the State Pollution Control Board (SPCB) required before setting up or operating any industry that may pollute air or water. YMW Compliance provides end-to-end assistance in obtaining CTE/CTO from Jharkhand SPCB and all state PCBs across India.",
    benefits: [
  ...
  },
  {
    ...
    icon: "💻",
    description:
      "E-Waste Recycling Authorization is required for producers, refurbishers, recyclers, and dismantlers of electronic and electrical equipment under the E-Waste Management Rules. Issued by the Central Pollution Control Board (CPCB), this authorization ensures responsible e-waste management.",
    benefits: [
  ...
  },
  {
    ...
    icon: "⚠️",
    description:
      "Industries generating, handling, storing, or disposing of hazardous waste must obtain authorization from the State Pollution Control Board (SPCB) under the Hazardous and Other Wastes (Management and Transboundary Movement) Rules. YMW Compliance provides complete assistance for hazardous waste authorization and annual returns.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🏥",
    description:
      "Hospitals, clinics, diagnostic labs, blood banks, and other healthcare facilities must obtain Biomedical Waste Authorization from the SPCB under the Biomedical Waste Management Rules. YMW Compliance ensures complete authorization and annual compliance for healthcare facilities.",
    benefits: [
