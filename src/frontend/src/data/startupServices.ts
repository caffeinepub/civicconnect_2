...
export const STARTUP_SERVICES: StartupServiceItem[] = [
  ...
  },
  {
    ...
    icon: "😇",
    description:
      "Angel Tax Exemption under Section 56(2)(viib) protects startups from being taxed on investments received above Fair Market Value. YMW Compliance assists DPIIT-recognized startups in filing Form-2 with DPIIT and obtaining the angel tax exemption certificate to secure investor confidence.",
    benefits: [
  ...
  },
  {
    ...
    icon: "💡",
    description:
      "DPIIT-recognized startups enjoy fast-tracked patent examination at 80% rebate on official filing fees. YMW Compliance assists startups with prior art search, patent drafting, Form-1/2/3/5 filing, and complete prosecution before the Indian Patent Office to secure your core innovations.",
    benefits: [
  ...
  },
  {
    ...
    icon: "📄",
    description:
      "A well-structured business plan is essential for fundraising, bank loans, government schemes, and strategic clarity. YMW Compliance business experts prepare detailed, investor-ready business plans covering market analysis, financial projections, operational strategy, and competitive landscape.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🎯",
    description:
      "A compelling pitch deck is your first impression with investors. YMW Compliance creates powerful, story-driven pitch decks for startups seeking angel funding, VC investment, or government grants covering problem, solution, market size, business model, traction, and team.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🏗️",
    description:
      "All registered companies and LLPs must file annual returns, financial statements, and event-based forms with the Registrar of Companies (ROC). YMW Compliance handles all MCA filings including AOC-4, MGT-7, ADT-1, DIR-3 KYC, and more to keep your company fully compliant.",
    benefits: [
  ...
  },
  {
    ...
    icon: "📅",
    description:
      "Our Annual Compliance Package provides comprehensive compliance management for startups and SMEs covering ROC filings, GST returns, income tax returns, professional tax, and PF/ESI compliance all under a single affordable plan so you never miss a deadline.",
    benefits: [
  ...
  },
  {
    ...
    icon: "📉",
    description:
      "Our Virtual CFO service gives startups and growing businesses access to senior financial expertise at a fraction of the cost. YMW provides strategic financial planning, MIS reporting, investor reporting, cash flow management, fundraising support, and board-level financial advisory.",
    benefits: [
...
export const STARTUP_CATEGORIES = [
  {
    ...
    icon: "🚀",
    description:
      "5 services — Startup India, DPIIT, Angel Tax, Seed Fund, Patent",
    slugs: [
      "startup-india",
      "dpiit-recognition",
      "angel-tax-exemption",
  ...
  },
  {
    ...
    icon: "💡",
    description:
      "5 services — Business Plan, Pitch Deck, MCA ROC, Annual Compliance, Virtual CFO",
    slugs: [
      "business-plan",
      "pitch-deck",
      "mca-roc-compliance",
...
export function getStartupServiceBySlug(
  slug: string,
): StartupServiceItem | undefined {
