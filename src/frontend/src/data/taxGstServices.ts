...
export const TAX_GST_SERVICES: ServiceItem[] = [
  {
    slug: "gst-registration",
    title: "GST Registration",
    icon: "📋",
    description:
      "GST Registration is mandatory for businesses with turnover above the prescribed threshold or engaged in inter-state supply. YMW Compliance Services helps you register on the GST portal smoothly, obtain your GSTIN, and stay compliant from day one.",
    benefits: [
  ...
  },
  {
    ...
    icon: "📄",
    description:
      "Regular GST return filing (GSTR-1, GSTR-3B, GSTR-9) is mandatory for all registered taxpayers. YMW Compliance ensures accurate and timely filing to avoid penalties, interest, and suspension of GSTIN.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🌐",
    description:
      "A Letter of Undertaking (LUT) allows exporters to supply goods or services without paying GST, instead of claiming a refund later. YMW helps you file Form RFD-11 and obtain LUT approval quickly.",
    benefits: [
  ...
  },
  {
    ...
    icon: "📊",
    description:
      "GSTR-9 is the annual return that consolidates all monthly/quarterly returns filed during a financial year. YMW ensures accurate reconciliation of sales, purchases, ITC, and tax paid, keeping you compliant.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🧾",
    description:
      "Income Tax Return (ITR) filing is mandatory for individuals earning above the basic exemption limit. YMW's tax experts guide you through choosing the right ITR form, claiming all deductions, and filing accurately before the due date.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🏢",
    description:
      "Businesses, firms, LLPs, and companies must file ITR annually with correct financial data. YMW ensures proper filing with audited accounts, compliance with tax audit requirements, and timely submission.",
    benefits: [
  ...
  },
  {
    ...
    icon: "💼",
    description:
      "Any person or entity deducting TDS must file quarterly TDS returns (Form 24Q, 26Q, 27Q, 27EQ). YMW ensures accurate computation, timely filing, and issuance of Form 16/16A to deductees.",
    benefits: [
  ...
  },
  {
    ...
    icon: "📬",
    description:
      "Receiving an Income Tax notice can be stressful. YMW's expert CA team reviews the notice, prepares a detailed response, and represents you before the Income Tax Department to resolve issues quickly.",
    benefits: [
