...
export const TENDER_SERVICES: TenderServiceItem[] = [
  {
    slug: "gem-registration",
    title: "GeM Registration",
    icon: "🛍️",
    description:
      "Government e-Marketplace (GeM) is the national procurement portal for government departments and PSUs across India. YMW Compliance helps businesses register as sellers on GeM, set up product and service listings, and secure lucrative government orders through the platform with end-to-end support.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🚂",
    description:
      "IREPS (Indian Railways e-Procurement System) is the exclusive e-procurement portal for Indian Railways, one of the largest purchasers in the world. YMW Compliance handles complete vendor registration on IREPS, digital signature setup, and bid preparation to help you win railway contracts.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🏢",
    description:
      "CPPP (Central Public Procurement Portal) is the unified portal for all central government ministries and departments. YMW Compliance registers your business on CPPP, sets up e-procurement credentials, and provides ongoing support for bidding on central government tenders nationwide.",
    benefits: [
  ...
  },
  {
    ...
    icon: "💻",
    description:
      "State governments and PSUs operate their own e-procurement portals for state-level tenders. YMW Compliance registers your business on Jharkhand e-Procurement, NIC state portals, and major PSU platforms, and provides complete vendor qualification and bid submission support.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🛡️",
    description:
      "India defence procurement has opened up to domestic suppliers under Atmanirbhar Bharat. YMW Compliance assists with registration on the MoD vendor portal, DRDO procurement portal, and Defence Acquisition Portal (DAP) for businesses in defence manufacturing, supply, and services.",
    benefits: [
  ...
  },
  {
    ...
    icon: "📨",
    description:
      "Submitting a government tender requires precise documentation, proper formatting, and meeting strict technical and commercial requirements. YMW Compliance provides end-to-end tender submission services from eligibility check to bid finalization and online submission on any government portal.",
    benefits: [
  ...
  },
  {
    ...
    icon: "✅",
    description:
      "Many large organisations and government entities require vendors to undergo formal vendor assessment or empanelment before awarding contracts. YMW Compliance prepares your business for vendor assessment processes including quality audits, financial evaluations, and technical qualification reviews.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🎯",
    description:
      "Winning bids on GeM requires understanding pricing strategies, eligibility criteria, and bid ranking algorithms. YMW Compliance provides dedicated GeM bidding support helping you identify relevant bids, prepare competitive quotes, manage bid submissions, and respond to buyer queries on the platform.",
    benefits: [
  ...
  },
  {
    ...
    icon: "🏦",
    description:
      "EMD (Earnest Money Deposit) and Performance Bank Guarantees are mandatory financial security requirements in government tenders. YMW Compliance assists with EMD payment, bank guarantee arrangement, BG drafting as per NIT requirements, and coordination with banks for issuance and encashment.",
    benefits: [
...
export const TENDER_CATEGORIES = [
  ...
  },
  {
    ...
    icon: "📝",
    description:
      "5 services — Tender Submission, Vendor Assessment, GeM Bidding, Documentation, EMD",
    slugs: [
      "tender-submission",
      "vendor-assessment",
      "gem-bidding",
...
export function getTenderServiceBySlug(
  slug: string,
): TenderServiceItem | undefined {
