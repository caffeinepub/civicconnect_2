...
import {
  ...
  AGREEMENT_SERVICES,
} from "../data/agreementContractServices";

export default function AgreementContract() {
  const [openSection, setOpenSection] = useState<string | null>(
    AGREEMENT_CATEGORIES[0]?.key ?? null,
  );
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-sm text-gray-300">Agreement & Contract</span>
          </div>
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">
              Agreement & <span style={{ color: "#f5c518" }}>Contract</span>
            </h1>
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
              Get professionally drafted legal agreements and contracts for your
              business — rental agreements, NDAs, partnership deeds, service
              contracts, sale deeds, and more. Expert legal drafting with quick
              turnaround.
            </p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-extrabold text-white mb-2">
              Choose Your{" "}
              <span style={{ color: "#f5c518" }}>Agreement Type</span>
            </h2>
            <p className="text-gray-400 text-sm max-w-xl mx-auto">
              Select a category and click any agreement to see full details,
              required documents, and drafting process.
            </p>
          </div>
          <div className="space-y-4">
            {AGREEMENT_CATEGORIES.map((category) => {
              const services = AGREEMENT_SERVICES.filter((s) =>
      ...
      <section className="py-12 px-4" style={{ backgroundColor: "#f5c518" }}>
        <div className="max-w-4xl mx-auto text-center">
          <h2
            ...
            style={{ color: "#0a1628" }}
          >
            Need a Legal Agreement Drafted?
          </h2>
          <p
            className="text-base mb-6"
            style={{ color: "#0a1628", opacity: 0.8 }}
          >
            Our legal experts draft customized agreements that protect your
            interests and are legally enforceable across India.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:9279242122"
