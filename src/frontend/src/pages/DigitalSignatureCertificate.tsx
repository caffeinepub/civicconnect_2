...
import { DSC_CATEGORIES, DSC_SERVICES } from "../data/digitalSignatureServices";

export default function DigitalSignatureCertificate() {
  const [openSection, setOpenSection] = useState<string | null>(
    DSC_CATEGORIES[0]?.key ?? null,
  );
    ...
    <div style={{ backgroundColor: "#0a1628" }}>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">
              Digital Signature{" "}
              <span style={{ color: "#f5c518" }}>Certificate</span>
            </h1>
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
              Get your Digital Signature Certificate (DSC) for e-tendering, GST
              filing, income tax, MCA filings and all government portals. Class
              3 DSC issued within 1-2 days with expert support.
            </p>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-10">
            {[
              ...
              { value: "1-2 Days", label: "Quick Issuance" },
              { value: "Pan India", label: "Coverage" },
              { value: "100%", label: "Genuine DSC" },
            ].map((stat) => (
              <div
                key={stat.label}
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-extrabold text-white mb-2">
              Choose Your <span style={{ color: "#f5c518" }}>DSC Type</span>
            </h2>
          ...
          <div className="space-y-4">
            {DSC_CATEGORIES.map((category) => {
              const services = DSC_SERVICES.filter((s) =>
                  ...
                  {openSection === category.key && (
                    ...
                    >
                      {services.map((service, idx) => (
                        <Link
                          key={service.slug}
                          to="/services/digital-signature/$serviceSlug"
      ...
      <section className="py-12 px-4" style={{ backgroundColor: "#f5c518" }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Our experts issue genuine Class 3 DSC within 1-2 working days with
            full support.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
