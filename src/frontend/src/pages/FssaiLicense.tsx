...
import { FSSAI_SERVICES } from "../data/fssaiServices";
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-sm text-gray-300">FSSAI License</span>
          </div>
          ...
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">
              FSSAI <span style={{ color: "#f5c518" }}>License Services</span>
            </h1>
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
              Get your FSSAI Registration or License hassle-free — Basic
              Registration, State License, Central License, and Renewal.
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-extrabold text-white mb-2">
              Our <span style={{ color: "#f5c518" }}>FSSAI Services</span>
            </h2>
          ...
          >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-xs mt-0.5">
                    Basic, State License, Central License, Renewal
                  </p>
                </div>
              </div>
              <ArrowRight
            ...
            {open && (
              ...
              >
                {FSSAI_SERVICES.map((service, idx) => (
                  <Link
                    key={service.slug}
