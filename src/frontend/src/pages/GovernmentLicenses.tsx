...
import { GOVERNMENT_LICENSES_SERVICES } from "../data/governmentLicensesServices";

export default function GovernmentLicenses() {
  const [openSection, setOpenSection] = useState<
    "essential" | "specialized" | null
  >("essential");

  const ESSENTIAL = GOVERNMENT_LICENSES_SERVICES.filter((s) =>
    [
      "trade-license",
  ...
  const SPECIALIZED = GOVERNMENT_LICENSES_SERVICES.filter((s) =>
    [
      "psara-license",
      "peso-license",
      "ayush-license",
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-sm text-gray-300">Government Licenses</span>
          </div>
          ...
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">
              Government{" "}
              <span style={{ color: "#f5c518" }}>License Services</span>
            </h1>
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
              From Trade License and Fire NOC to PSARA, PESO, AYUSH, and Mining
              Licenses — we handle all government licensing with expert guidance
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-extrabold text-white mb-2">
              Choose Your <span style={{ color: "#f5c518" }}>License Type</span>
            </h2>
            <p className="text-gray-400 text-sm max-w-xl mx-auto">
              Select a category below and click any license to see full details,
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-xs mt-0.5">
                      4 licenses — Trade License, Shop & Establishment, Fire
                      NOC, Drug License
                    </p>
                  </div>
                </div>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-xs mt-0.5">
                      4 licenses — PSARA, PESO, AYUSH, Mining License
                    </p>
                  </div>
                </div>
                <ArrowRight
      ...
      <section className="py-12 px-4" style={{ backgroundColor: "#f5c518" }}>
        <div className="max-w-4xl mx-auto text-center">
          <h2
            ...
            style={{ color: "#0a1628" }}
          >
            Need Help With Government Licensing?
          </h2>
          <p
            className="text-base mb-6"
            style={{ color: "#0a1628", opacity: 0.8 }}
          >
            Our licensing experts handle all documentation and government
