...
import {
  GOVT_REG_CATEGORIES,
  GOVT_REG_SERVICES,
} from "../data/governmentRegistrationServices";

export default function GovernmentRegistration() {
  const [openSection, setOpenSection] = useState<string | null>(
    GOVT_REG_CATEGORIES[0]?.key ?? null,
  );
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">
              Government <span style={{ color: "#f5c518" }}>Registrations</span>
            </h1>
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
              From IEC and MSME to RERA, Fire NOC, and BIS Certification — YMW
              Compliance handles all your essential government registrations
              with expert guidance and pan-India support.
            </p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-extrabold text-white mb-2">
              Choose Your <span style={{ color: "#f5c518" }}>Registration</span>
            </h2>
          ...
          <div className="space-y-4">
            {GOVT_REG_CATEGORIES.map((category) => {
              const services = GOVT_REG_SERVICES.filter((s) =>
      ...
      <section className="py-12 px-4" style={{ backgroundColor: "#f5c518" }}>
        <div className="max-w-4xl mx-auto text-center">
          <h2
            ...
            style={{ color: "#0a1628" }}
          >
            Need Help With Government Registration?
          </h2>
          <p
            className="text-base mb-6"
            style={{ color: "#0a1628", opacity: 0.8 }}
          >
            Our experts handle all registrations and filings on your behalf —
            pan India coverage.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
