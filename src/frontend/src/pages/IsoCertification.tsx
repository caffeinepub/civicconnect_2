...
import { ISO_CERTIFICATION_SERVICES } from "../data/isoCertificationServices";

export default function IsoCertification() {
  const [openSection, setOpenSection] = useState<
    "quality" | "specialized" | null
  >("quality");

  const QUALITY_SYSTEMS = ISO_CERTIFICATION_SERVICES.filter((s) =>
    ["iso-9001", "iso-14001", "iso-22000", "iso-45001"].includes(s.slug),
  );
  const SPECIALIZED = ISO_CERTIFICATION_SERVICES.filter((s) =>
    ["iso-27001", "iso-50001", "iso-13485", "iso-37001"].includes(s.slug),
  );
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-sm text-gray-300">ISO Certification</span>
          </div>
          ...
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">
              ISO{" "}
              <span style={{ color: "#f5c518" }}>Certification Services</span>
            </h1>
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
              Get your business internationally certified — ISO 9001, 14001,
              22000, 27001, 45001 and more. We handle documentation, audit
              coordination, and certificate issuance end-to-end.
            </p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-extrabold text-white mb-2">
              Choose Your{" "}
              <span style={{ color: "#f5c518" }}>ISO Certification</span>
            </h2>
            <p className="text-gray-400 text-sm max-w-xl mx-auto">
              Select a category and click any certification to view full
              details, benefits, required documents, and process.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            >
              <button
                type="button"
                onClick={() =>
                  setOpenSection(openSection === "quality" ? null : "quality")
                }
              ...
              {openSection === "quality" && (
                ...
                >
                  {QUALITY_SYSTEMS.map((service, idx) => (
                    <Link
                      key={service.slug}
            ...
            {/* Specialized ISO Certifications */}
            <div
              className="rounded-2xl overflow-hidden"
              style={{ border: "2px solid #FFC107" }}
            ...
            >
              ...
              {openSection === "specialized" && (
                <div
                  className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-5"
                  style={{ backgroundColor: "rgba(255,255,255,0.02)" }}
                >
                  {SPECIALIZED.map((service, idx) => (
                    <Link
                      key={service.slug}
                      to="/services/iso-certification/$serviceSlug"
                      params={{ serviceSlug: service.slug }}
      ...
      <section className="py-12 px-4" style={{ backgroundColor: "#f5c518" }}>
        <div className="max-w-4xl mx-auto text-center">
          <h2
            ...
            style={{ color: "#0a1628" }}
          >
            Need ISO Certification Guidance?
          </h2>
          <p
            className="text-base mb-6"
            style={{ color: "#0a1628", opacity: 0.8 }}
          >
            Our experts are available Mon–Sat 10 AM to 6 PM for a free
            consultation.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
