...
import { LABOUR_CATEGORIES, LABOUR_SERVICES } from "../data/labourDeptServices";

export default function LabourDept() {
  const [openSection, setOpenSection] = useState<string | null>(
    LABOUR_CATEGORIES[0]?.key ?? null,
  );
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-sm text-gray-300">Labour Department</span>
          </div>
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">
              Labour <span style={{ color: "#f5c518" }}>Department</span>
            </h1>
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
              From PF and ESI registration to Contract Labour License, Shops
              Act, and all monthly compliance returns — YMW Compliance manages
              your complete labour department compliance with expert guidance
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-extrabold text-white mb-2">
              Choose Your{" "}
              <span style={{ color: "#f5c518" }}>Labour Service</span>
            </h2>
          ...
          <div className="space-y-4">
            {LABOUR_CATEGORIES.map((category) => {
              const services = LABOUR_SERVICES.filter((s) =>
      ...
      <section className="py-12 px-4" style={{ backgroundColor: "#f5c518" }}>
        <div className="max-w-4xl mx-auto text-center">
          <h2
            ...
            style={{ color: "#0a1628" }}
          >
            Need Help With Labour Compliance?
          </h2>
          <p
            className="text-base mb-6"
            style={{ color: "#0a1628", opacity: 0.8 }}
          >
            Our labour compliance experts handle all registrations and monthly
