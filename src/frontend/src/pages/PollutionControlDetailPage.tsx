...
import { getServiceBySlug } from "../data/pollutionControlServices";
...
export default function PollutionControlDetailPage() {
  // @ts-ignore
      ...
      <div className="max-w-6xl mx-auto px-4 pb-20 flex flex-col lg:flex-row gap-6 items-start">
        ...
        <div className="flex-1 flex flex-col gap-5 min-w-0">
          ...
          <div>
            ...
            >
              <ArrowLeft className="w-4 h-4" /> Back to Pollution Control Board
            </Link>
          </div>
        </div>
