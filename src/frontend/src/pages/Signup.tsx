              ...
              <div className="flex flex-col items-center gap-6 text-center">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-sm leading-relaxed">
                    Use Internet Identity for secure, passwordless
                    authentication. No personal data is stored by the identity
                    provider.
                  </p>
                </div>
                <button
                ...
                <p className="text-xs text-gray-500">
                  ...
                  identity is secured by the Internet Computer blockchain.
                </p>
              </div>
            )}
          </div>
