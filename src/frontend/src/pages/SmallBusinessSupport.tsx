...
} from "../data/smallBusinessServices";

export default function SmallBusinessSupport() {
  const [openSection, setOpenSection] = useState<string | null>(
    SMALL_BUSINESS_CATEGORIES[0]?.key ?? null,
  );
    ...
    <div style={{ backgroundColor: "#0a1628" }}>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">
              Small Business{" "}
              <span style={{ color: "#f5c518" }}>Support Services</span>
            </h1>
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
              From Business Plan and Project Report to MUDRA Loans, Startup
              India Registration, and Business Mentorship — YMW Compliance is
              your complete support partner for small businesses, MSMEs, and
              entrepreneurs.
            </p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-extrabold text-white mb-2">
              Choose Your{" "}
              <span style={{ color: "#f5c518" }}>Support Service</span>
            </h2>
          ...
          <div className="space-y-4">
            {SMALL_BUSINESS_CATEGORIES.map((category) => {
              const services = SMALL_BUSINESS_SERVICES.filter((s) =>
                  ...
                  >
                    ...
                    <ArrowRight
                      className={`w-5 h-5 transition-transform duration-200 ${
                        openSection === category.key ? "rotate-90" : ""
                      }`}
                      style={{ color: "#f5c518" }}
                    />
                  </button>
      ...
      <section className="py-12 px-4" style={{ backgroundColor: "#f5c518" }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Our experts help MSMEs, entrepreneurs, and startups with everything
            from loan paperwork to investor pitches — all under one roof.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:9279242122"
