...
import { STARTUP_CATEGORIES, STARTUP_SERVICES } from "../data/startupServices";

export default function StartupService() {
  const [openSection, setOpenSection] = useState<string | null>(
    STARTUP_CATEGORIES[0]?.key ?? null,
  );
    ...
    <div style={{ backgroundColor: "#0a1628" }}>
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-sm text-gray-300">Startup Services</span>
          </div>
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">
              Startup <span style={{ color: "#f5c518" }}>Services</span>
            </h1>
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
              From DPIIT Recognition and Angel Tax Exemption to Seed Fund,
              Patent Filing, and Virtual CFO — YMW Compliance is your full-stack
              startup advisory partner from incorporation to fundraising.
            </p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-extrabold text-white mb-2">
              Choose Your{" "}
              <span style={{ color: "#f5c518" }}>Startup Service</span>
            </h2>
          ...
          <div className="space-y-4">
            {STARTUP_CATEGORIES.map((category) => {
              const services = STARTUP_SERVICES.filter((s) =>
      ...
      <section className="py-12 px-4" style={{ backgroundColor: "#f5c518" }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Our startup experts guide you from registration to fundraising —
            focus on building while we handle compliance.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:9279242122"
