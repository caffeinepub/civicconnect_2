...
import { getStartupServiceBySlug } from "../data/startupServices";
...
export default function StartupServiceDetailPage() {
  // @ts-ignore
      ...
      <div className="max-w-6xl mx-auto px-4 py-6 grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        <div className="lg:col-span-2 space-y-8">
          ...
          <div className="flex items-center gap-2">
            ...
            >
              <ArrowLeft className="w-4 h-4" /> Back to Startup Services
            </Link>
          </div>
        </div>
