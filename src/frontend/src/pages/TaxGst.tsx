...
import { TAX_GST_SERVICES } from "../data/taxGstServices";

export default function TaxGst() {
  const [openSection, setOpenSection] = useState<"direct" | "indirect" | null>(
    "indirect",
  );

  const INDIRECT_TAX = TAX_GST_SERVICES.filter((s) =>
    [
      "gst-registration",
      "gst-return-filing",
      "gst-lut-for-export",
  ...
  const DIRECT_TAX = TAX_GST_SERVICES.filter((s) =>
    [
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-sm text-gray-300">Tax &amp; GST</span>
          </div>
          ...
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">
              Tax &amp; GST <span style={{ color: "#f5c518" }}>Services</span>
            </h1>
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
              From GST registration and return filing to ITR, TDS, and tax
              notices — we handle all your direct and indirect tax compliance
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-extrabold text-white mb-2">
              Choose Your <span style={{ color: "#f5c518" }}>Tax Service</span>
            </h2>
          ...
          <div className="space-y-4">
            ...
            >
              <button
                type="button"
                onClick={() =>
                  setOpenSection(openSection === "indirect" ? null : "indirect")
                }
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-xs mt-0.5">
                      4 services — GST Registration, Returns, LUT, Annual Return
                    </p>
                  </div>
                </div>
                <ArrowRight
            ...
            >
              <button
                type="button"
                onClick={() =>
                  setOpenSection(openSection === "direct" ? null : "direct")
                }
                className="w-full flex items-center justify-between px-6 py-4 text-left"
                style={{ backgroundColor: "rgba(245,197,24,0.10)" }}
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 text-xs mt-0.5">
                      4 services — ITR Filing, TDS Return, Tax Notices
                    </p>
                  </div>
                </div>
                <ArrowRight
      ...
      <section className="py-12 px-4" style={{ backgroundColor: "#f5c518" }}>
        <div className="max-w-4xl mx-auto text-center">
          <h2
            ...
            style={{ color: "#0a1628" }}
          >
            Need Tax or GST Guidance?
          </h2>
          <p
            className="text-base mb-6"
            style={{ color: "#0a1628", opacity: 0.8 }}
          >
            Our CA experts are available Mon–Sat 10 AM to 6 PM for a free
            consultation.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
