...
import { TENDER_CATEGORIES, TENDER_SERVICES } from "../data/tenderServices";

export default function TenderService() {
  const [openSection, setOpenSection] = useState<string | null>(
    TENDER_CATEGORIES[0]?.key ?? null,
  );
    ...
    <div style={{ backgroundColor: "#0a1628" }}>
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-sm text-gray-300">Tender Services</span>
          </div>
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">
              Tender <span style={{ color: "#f5c518" }}>Services</span>
            </h1>
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
              From GeM and IREPS registration to Tender Submission, Vendor
              Assessment, and Bank Guarantee Assistance — YMW Compliance is your
              complete government procurement partner for winning contracts at
              every level.
            </p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-extrabold text-white mb-2">
              Choose Your{" "}
              <span style={{ color: "#f5c518" }}>Tender Service</span>
            </h2>
          ...
          <div className="space-y-4">
            {TENDER_CATEGORIES.map((category) => {
              const services = TENDER_SERVICES.filter((s) =>
      ...
      <section className="py-12 px-4" style={{ backgroundColor: "#f5c518" }}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            Our tender experts handle registration, bid preparation, and
