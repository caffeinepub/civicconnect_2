...
import { TRADEMARK_SERVICES } from "../data/trademarkServices";
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span className="text-sm text-gray-300">Trademark & IP</span>
          </div>
          ...
          <div className="text-center">
            ...
            <h1 className="text-4xl md:text-5xl font-extrabold text-white mb-4">
              Trademark <span style={{ color: "#f5c518" }}>& IP Services</span>
            </h1>
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
              Protect your brand, innovation, and creative works — Trademark
              Registration, Copyright, Patent, and Design Registration.
              India-wide IP protection done right.
            </p>
        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl md:text-3xl font-extrabold text-white mb-2">
              Our{" "}
              <span style={{ color: "#f5c518" }}>Trademark & IP Services</span>
            </h2>
            <p className="text-gray-400 text-sm max-w-xl mx-auto">
              Select any service to view full details, required documents,
              process, and get a free consultation.
            </p>
          </div>
          ...
          >
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400 text-xs mt-0.5">
                    Trademark, Copyright, Patent, Design Registration
                  </p>
                </div>
              </div>
              <ArrowRight
            ...
            {open && (
              ...
              >
                {TRADEMARK_SERVICES.map((service, idx) => (
                  <Link
                    key={service.slug}
